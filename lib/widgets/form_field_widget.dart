                ...
                child: Stack(
                  children: [
                    TextFormField(
                      ...
                      maxLines:
                          null, // Allows unlimited lines but within fixed height
                      expands: true, // Makes text expand inside fixed container
                      textAlignVertical:
                          TextAlignVertical.top, // Aligns input text to the top
          ...
          : Form(
              ...
              child: TextFormField(
                ...
                maxLines: _obscureText
                    ? 1
                    : _maxLines, // Ensure maxLines is 1 when obscureText is true
                decoration: InputDecoration(
                  errorText: widget.errorText,
